...
<body>
    ...
    <div class="container mt-4">
        ...
        <!-- =================================================================== -->
        <!-- ##            AWAL PERUBAHAN STRUKTUR KONTEN                     ## -->
        <!-- =================================================================== -->
        <div class="card shadow-sm mb-4">
            ...
            <div class="card-body p-4">
                <!-- ## Bagian Pendaftaran sebagai Peserta ## -->
                <div class="p-3 mb-3 border rounded">
                    <h5><i class="fas fa-user me-2"></i>Partisipasi sebagai Peserta</h5>
                    <?php if (!$registration_peserta): // JIKA BELUM TERDAFTAR SEBAGAI PESERTA ?>
                        ...
                        <?= form_open('user/dashboard/register_for_event'); ?>
                            ...
                            <button type="submit" name="peran" value="peserta" class="btn btn-outline-primary">Daftar sebagai Peserta</button>
                        <?= form_close(); ?>
                    <?php else: // JIKA SUDAH TERDAFTAR SEBAGAI PESERTA, TAMPILKAN STATUSNYA ?>
                ...
                <div class="p-3 border rounded">
                    ...
                    <?php if (!$registration_presenter): // JIKA BELUM TERDAFTAR SEBAGAI PRESENTER ?>
                        ...
                        <?= form_open('user/dashboard/register_for_event'); ?>
                            <input type="hidden" name="event_id" value="<?= $active_event->event_id; ?>">
                            <button type="submit" name="peran" value="presenter" class="btn btn-outline-success">Daftar sebagai Presenter</button>
                        <?= form_close(); ?>
